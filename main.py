...
def main():
    ...
    language = 'javascript'
    projects = LANGAUGE_PROJECTS[language]
        ...
        try:
            ...
            for index, dir in enumerate(sub_dirs):
                ...
                if index in range(6):
                    ...
                    if index == 0:
                        save_name = f'{language}/commits/change_codes_deepjit_{language}_train_dict.pkl'
                    ...
                    if index == 3:
                        save_name = f'{language}/commits/change_codes_simcom_{language}_train_dict.pkl'
                        dict = create_dict(language_commit[1], language_commit[2])
